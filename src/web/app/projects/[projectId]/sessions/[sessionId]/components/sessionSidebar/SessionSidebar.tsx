...
import { CalendarClockIcon, ListTodoIcon, MessageSquareIcon, PlugIcon } from "lucide-react";
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <BackButton className="w-(--spacing-sidebar-icon-menu) h-(--spacing-sidebar-icon-menu) flex items-center justify-center hover:bg-sidebar-accent transition-colors" />
              </TooltipTrigger>
